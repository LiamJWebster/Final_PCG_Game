...
public class Tilemap_test_Gen : MonoBehaviour
{
    ...
    [SerializeField] private Tilemap Liam_Tiles;
    ...
    void GenerateFloorExp()
    {
        ...
        for (int x = 0; x < 78; x++)
        {
            for (int y = 0; y < 24; y++)
            {
                ...
                */
                ...
                if (value == 0)
                {
                    Liam_Tiles.SetTile(tilePos, wall);
                }
                else
                {
                    Liam_Tiles.SetTile(tilePos, floor);
                }
        ...
        m_OrthographicCamera.orthographicSize = (float)20;
    }
